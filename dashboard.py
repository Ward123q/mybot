...
async def handle_chat_settings(request: web.Request):
    ...
    if request.method == "POST":
        ...
        # ⏰ Расписание
        settings["schedule_enabled"]    = data.get("schedule_enabled") == "1"
        settings["close_time"]          = data.get("close_time", "00:00")
        settings["open_time"]           = data.get("open_time", "08:00")
        settings["quiet_enabled"]       = data.get("quiet_enabled") == "1"
        settings["quiet_start"]         = data.get("quiet_start", "23:00")
        settings["quiet_end"]           = data.get("quiet_end", "07:00")

        # &#128737; Модерация
        settings["max_warns"]           = int(data.get("max_warns", 3))
        settings["warn_expiry_days"]    = int(data.get("warn_expiry_days", 30))
        settings["mute_duration"]       = int(data.get("mute_duration", 60))
        settings["auto_mute_newcomers"] = data.get("auto_mute_newcomers") == "1"
        settings["newcomer_mute_hours"] = int(data.get("newcomer_mute_hours", 1))
        settings["auto_kick_inactive"]  = data.get("auto_kick_inactive") == "1"
        settings["inactive_days"]       = int(data.get("inactive_days", 30))

        # &#128075; Приветствие
        settings["welcome_enabled"]     = data.get("welcome_enabled") == "1"
        settings["welcome_text"]        = data.get("welcome_text", "&#128075; {name}!")
        settings["welcome_delete_prev"] = data.get("welcome_delete_prev") == "1"
        settings["verify_enabled"]      = data.get("verify_enabled") == "1"
        settings["verify_question"]     = data.get("verify_question", "")
        settings["verify_answer"]       = data.get("verify_answer", "")

        # &#129302; Антиспам
        settings["antispam_enabled"]    = data.get("antispam_enabled") == "1"
        settings["antimat_enabled"]     = data.get("antimat_enabled") == "1"
        settings["flood_msgs"]          = int(data.get("flood_msgs", 10))
        settings["flood_action"]        = data.get("flood_action", "mute")
        settings["antilink_enabled"]    = data.get("antilink_enabled") == "1"
        settings["antisticker_enabled"] = data.get("antisticker_enabled") == "1"
        settings["anticaps_enabled"]    = data.get("anticaps_enabled") == "1"
        settings["caps_percent"]        = int(data.get("caps_percent", 70))

        # &#127918; Функции
        settings["xp_enabled"]          = data.get("xp_enabled") == "1"
        settings["rep_enabled"]         = data.get("rep_enabled") == "1"
        settings["games_enabled"]       = data.get("games_enabled") == "1"
        settings["economy_enabled"]     = data.get("economy_enabled") == "1"
        settings["anon_enabled"]        = data.get("anon_enabled") == "1"
        settings["clans_enabled"]       = data.get("clans_enabled") == "1"

        # &#127942; Экономика
        settings["xp_per_msg"]          = int(data.get("xp_per_msg", 5))
        settings["rep_cooldown_hours"]  = int(data.get("rep_cooldown_hours", 1))
        settings["daily_bonus"]         = int(data.get("daily_bonus", 50))
        settings["newcomer_bonus"]      = int(data.get("newcomer_bonus", 100))

        # &#128226; Авто-объявления
        settings["announce_enabled"]    = data.get("announce_enabled") == "1"
        settings["announce_text"]       = data.get("announce_text", "")
        settings["announce_interval"]   = int(data.get("announce_interval", 100))
        settings["rules_remind_enabled"]= data.get("rules_remind_enabled") == "1"
        settings["rules_remind_interval"]= int(data.get("rules_remind_interval", 200))

        cs.save_settings(cid, settings)
        _log_admin_action(f"&#9881;&#65039; &#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; &#1095;&#1072;&#1090;&#1072; {cid} &#1086;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1099;")
    ...
    def tog(key):
        ...
        return (
            ...
            f'<input type="checkbox" name="{key}" value="1" {"checked" if val else ""}>'
            f'<span class="toggle-slider"></span></label>'
        )

    def inp(key, type_="text", min_=None, max_=None):
        val = s.get(key, "")
    ...
    def sel(key, options):
        ...
        return f'<select class="form-control" name="{key}">{opts}</select>'

    chat_opts = "".join(
        f'<option value="{r["cid"]}" {"selected" if r["cid"]==cid else ""}>{r["title"] or r["cid"]}</option>'
        for r in chats
    )

    chat_title = next((r["title"] for r in chats if r["cid"]==cid), str(cid))

    def section(title, *rows):
        content = "".join(
            f'<div style="display:flex;justify-content:space-between;align-items:center;'
            f'padding:12px 0;border-bottom:1px solid var(--border);">'
            f'<div><b>{label}</b><div style="font-size:12px;color:var(--text2);">{desc}</div></div>'
            f'<div style="min-width:120px;text-align:right;">{ctrl}</div></div>'
            for label, desc, ctrl in rows
        )
        return (
            f'<div class="section" style="margin-bottom:20px;">'
            f'<div class="section-header">{title}</div>'
            f'<div style="padding:0 20px;">{content}</div></div>'
        )

    body = navbar("chats") + f"""
    <div class="container">
      <div class="page-title">
        &#9881;&#65039; &#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080;: {chat_title}
        <a href="/dashboard/chats" style="font-size:14px;color:var(--accent);margin-left:16px;">&#8592; &#1053;&#1072;&#1079;&#1072;&#1076;</a>
      </div>
      <div style="margin-bottom:16px;">
        <form method="GET" style="display:flex;gap:12px;">
          <select class="form-control" name="dummy" onchange="window.location='/dashboard/chat_settings/'+this.value" style="width:250px;">
            {chat_opts}
          </select>
        </form>
      </div>
      <form method="POST">
        {section("&#9200; &#1056;&#1072;&#1089;&#1087;&#1080;&#1089;&#1072;&#1085;&#1080;&#1077; &#1095;&#1072;&#1090;&#1072;",
            ("&#128275; &#1072;&#1074;&#1090;&#1086;-&#1079;&#1072;&#1082;&#1088;&#1099;&#1090;&#1080;&#1077;/&#1086;&#1090;&#1082;&#1088;&#1099;&#1090;&#1080;&#1077;", "&#1063;&#1072;&#1090; &#1079;&#1072;&#1082;&#1088;&#1099;&#1074;&#1072;&#1077;&#1090;&#1089;&#1103; &#1080; &#1086;&#1090;&#1082;&#1088;&#1099;&#1074;&#1072;&#1077;&#1090;&#1089;&#1103; &#1087;&#1086; &#1088;&#1072;&#1089;&#1087;&#1080;&#1089;&#1072;&#1085;&#1080;&#1102;", tog("schedule_enabled")),
            ("&#128274; &#1047;&#1072;&#1082;&#1088;&#1099;&#1090;&#1100; &#1074;", "&#1042;&#1088;&#1077;&#1084;&#1103; &#1079;&#1072;&#1082;&#1088;&#1099;&#1090;&#1080;&#1103;", inp("close_time","time")),
            ("&#128275; &#1054;&#1090;&#1082;&#1088;&#1099;&#1090;&#1100; &#1074;", "&#1042;&#1088;&#1077;&#1084;&#1103; &#1086;&#1090;&#1082;&#1088;&#1099;&#1090;&#1080;&#1103;", inp("open_time","time")),
            ("&#127769; &#1058;&#1080;&#1093;&#1080;&#1081; &#1095;&#1072;&#1089;", "&#1058;&#1086;&#1083;&#1100;&#1082;&#1086; &#1095;&#1090;&#1077;&#1085;&#1080;&#1077; &#1074; &#1085;&#1086;&#1095;&#1085;&#1086;&#1077; &#1074;&#1088;&#1077;&#1084;&#1103;", tog("quiet_enabled")),
            ("&#127763; &#1058;&#1080;&#1093;&#1080;&#1081; &#1095;&#1072;&#1089; &#1089;", "&#1053;&#1072;&#1095;&#1072;&#1083;&#1086;", inp("quiet_start","time")),
            ("&#9728;&#65039; &#1058;&#1080;&#1093;&#1080;&#1081; &#1095;&#1072;&#1089; &#1076;&#1086;", "&#1054;&#1082;&#1086;&#1085;&#1095;&#1072;&#1085;&#1080;&#1077;", inp("quiet_end","time")),
        )}
        {section("&#128737; &#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; &#1084;&#1086;&#1076;&#1077;&#1088;&#1072;&#1094;&#1080;&#1080;",
            ("&#9889; &#1052;&#1072;&#1082;&#1089; &#1074;&#1072;&#1088;&#1085;&#1086;&#1074;", "&#1040;&#1074;&#1090;&#1086;&#1073;&#1072;&#1085; &#1087;&#1086;&#1089;&#1083;&#1077; N &#1074;&#1072;&#1088;&#1085;&#1086;&#1074;", inp("max_warns","number","1","10")),
            ("&#128337; &#1057;&#1088;&#1086;&#1082; &#1074;&#1072;&#1088;&#1085;&#1072; (&#1076;&#1085;&#1077;&#1081;)", "&#1063;&#1077;&#1088;&#1077;&#1079; &#1089;&#1082;&#1086;&#1083;&#1100;&#1082;&#1086; &#1076;&#1085;&#1077;&#1081; &#1089;&#1075;&#1086;&#1088;&#1072;&#1077;&#1090;", inp("warn_expiry_days","number","1","365")),
            ("&#128263; &#1044;&#1083;&#1080;&#1090;&#1077;&#1083;&#1100;&#1085;&#1086;&#1089;&#1090;&#1100; &#1084;&#1091;&#1090;&#1072; (&#1084;&#1080;&#1085;)", "&#1055;&#1086; &#1091;&#1084;&#1086;&#1083;&#1095;&#1072;&#1085;&#1080;&#1102;", inp("mute_duration","number","1","10080")),
            ("&#128274; &#1040;&#1074;&#1090;&#1086;&#1084;&#1091;&#1090; &#1085;&#1086;&#1074;&#1080;&#1095;&#1082;&#1086;&#1074;", "&#1052;&#1091;&#1090; &#1085;&#1086;&#1074;&#1099;&#1093; &#1091;&#1095;&#1072;&#1089;&#1090;&#1085;&#1080;&#1082;&#1086;&#1074;", tog("auto_mute_newcomers")),
            ("&#8987; &#1053;&#1072; &#1089;&#1082;&#1086;&#1083;&#1100;&#1082;&#1086; &#1095;&#1072;&#1089;&#1086;&#1074;", "&#1054;&#1090;&#1074;&#1077;&#1095;&#1072;&#1077;&#1090; &#1079;&#1072; &#1072;&#1074;&#1090;&#1086;&#1084;&#1091;&#1090; &#1085;&#1086;&#1074;&#1080;&#1095;&#1082;&#1086;&#1074;", inp("newcomer_mute_hours","number","1","72")),
            ("&#128465; &#1040;&#1074;&#1090;&#1086;&#1082;&#1080;&#1082; &#1085;&#1077;&#1072;&#1082;&#1090;&#1080;&#1074;&#1085;&#1099;&#1093;", "&#1050;&#1080;&#1082;&#1072;&#1090;&#1100; &#1077;&#1089;&#1083;&#1080; &#1084;&#1086;&#1083;&#1095;&#1072;&#1083; N &#1076;&#1085;&#1077;&#1081;", tog("auto_kick_inactive")),
            ("&#128197; &#1044;&#1085;&#1077;&#1081; &#1076;&#1086; &#1072;&#1074;&#1090;&#1086;&#1082;&#1080;&#1082;&#1072;", "", inp("inactive_days","number","1","365")),
        )}
        {section("&#128075; &#1055;&#1088;&#1080;&#1074;&#1077;&#1090;&#1089;&#1090;&#1074;&#1080;&#1077;",
            ("&#128075; &#1042;&#1082;&#1083;&#1102;&#1095;&#1080;&#1090;&#1100;", "&#1055;&#1086;&#1082;&#1072;&#1079;&#1099;&#1074;&#1072;&#1090;&#1100; &#1087;&#1088;&#1080;&#1074;&#1077;&#1090;&#1089;&#1090;&#1074;&#1080;&#1077;", tog("welcome_enabled")),
            ("&#128221; &#1058;&#1077;&#1082;&#1089;&#1090; &#1087;&#1088;&#1080;&#1074;&#1077;&#1090;&#1089;&#1090;&#1074;&#1080;&#1103;", "{{name}} &#8212; &#1080;&#1084;&#1103; &#1091;&#1095;&#1072;&#1089;&#1090;&#1085;&#1080;&#1082;&#1072;", f'<textarea class="form-control" name="welcome_text" rows="2">{s.get("welcome_text","")}</textarea>'),
            ("&#128465; &#1059;&#1076;&#1072;&#1083;&#1103;&#1090;&#1100; &#1089;&#1090;&#1072;&#1088;&#1086;&#1077;", "&#1059;&#1076;&#1072;&#1083;&#1103;&#1090;&#1100; &#1087;&#1088;&#1077;&#1076;&#1099;&#1076;&#1091;&#1097;&#1077;&#1077; &#1087;&#1088;&#1080;&#1074;&#1077;&#1090;&#1089;&#1090;&#1074;&#1080;&#1077;", tog("welcome_delete_prev")),
            ("&#9989; &#1042;&#1077;&#1088;&#1080;&#1092;&#1080;&#1082;&#1072;&#1094;&#1080;&#1103;", "&#1047;&#1072;&#1076;&#1072;&#1074;&#1072;&#1090;&#1100; &#1074;&#1086;&#1087;&#1088;&#1086;&#1089; &#1087;&#1088;&#1080; &#1074;&#1093;&#1086;&#1076;&#1077;", tog("verify_enabled")),
            ("&#10067; &#1042;&#1086;&#1087;&#1088;&#1086;&#1089;", "&#1042;&#1086;&#1087;&#1088;&#1086;&#1089; &#1076;&#1083;&#1103; &#1074;&#1077;&#1088;&#1080;&#1092;&#1080;&#1082;&#1072;&#1094;&#1080;&#1080;", inp("verify_question")),
            ("&#9989; &#1054;&#1090;&#1074;&#1077;&#1090;", "&#1055;&#1088;&#1072;&#1074;&#1080;&#1083;&#1100;&#1085;&#1099;&#1081; &#1086;&#1090;&#1074;&#1077;&#1090;", inp("verify_answer")),
        )}
        {section("&#129302; &#1040;&#1085;&#1090;&#1080;&#1089;&#1087;&#1072;&#1084;",
            ("&#129302; &#1040;&#1085;&#1090;&#1080;&#1089;&#1087;&#1072;&#1084;", "&#1060;&#1083;&#1091;&#1076;/&#1089;&#1087;&#1072;&#1084; &#1079;&#1072;&#1097;&#1080;&#1090;&#1072;", tog("antispam_enabled")),
            ("&#129324; &#1040;&#1085;&#1090;&#1080;&#1084;&#1072;&#1090;", "&#1060;&#1080;&#1083;&#1100;&#1090;&#1088; &#1085;&#1077;&#1094;&#1077;&#1085;&#1079;&#1091;&#1088;&#1085;&#1099;&#1093; &#1089;&#1083;&#1086;&#1074;", tog("antimat_enabled")),
            ("&#128308; &#1055;&#1086;&#1088;&#1086;&#1075; &#1092;&#1083;&#1091;&#1076;&#1072; (&#1089;&#1086;&#1086;&#1073;&#1097;/&#1084;&#1080;&#1085;)", "", inp("flood_msgs","number","3","60")),
            ("&#128296; &#1044;&#1077;&#1081;&#1089;&#1090;&#1074;&#1080;&#1077; &#1087;&#1088;&#1080; &#1092;&#1083;&#1091;&#1076;&#1077;", "", sel("flood_action", [("mute","&#128263; &#1052;&#1091;&#1090;"),("warn","&#9889; &#1042;&#1072;&#1088;&#1085;"),("kick","&#128095; &#1050;&#1080;&#1082;")])),
            ("&#128279; &#1040;&#1085;&#1090;&#1080;&#1083;&#1080;&#1085;&#1082;", "&#1059;&#1076;&#1072;&#1083;&#1103;&#1090;&#1100; &#1089;&#1089;&#1099;&#1083;&#1082;&#1080;", tog("antilink_enabled")),
            ("&#127383; &#1040;&#1085;&#1090;&#1080;&#1089;&#1090;&#1080;&#1082;&#1077;&#1088;", "&#1059;&#1076;&#1072;&#1083;&#1103;&#1090;&#1100; &#1089;&#1090;&#1080;&#1082;&#1077;&#1088;&#1099;", tog("antisticker_enabled")),
            ("&#128292; &#1040;&#1085;&#1090;&#1080;&#1082;&#1072;&#1087;&#1089;", f"&#1059;&#1076;&#1072;&#1083;&#1103;&#1090;&#1100; &#1077;&#1089;&#1083;&#1080; >{s.get('caps_percent',70)}% &#1079;&#1072;&#1075;&#1083;&#1072;&#1074;&#1085;&#1099;&#1093;", tog("anticaps_enabled")),
        )}
        {section("&#127918; &#1060;&#1091;&#1085;&#1082;&#1094;&#1080;&#1080;",
            ("&#11088; XP &#1089;&#1080;&#1089;&#1090;&#1077;&#1084;&#1072;", "&#1054;&#1087;&#1099;&#1090; &#1079;&#1072; &#1089;&#1086;&#1086;&#1073;&#1097;&#1077;&#1085;&#1080;&#1103;", tog("xp_enabled")),
            ("&#11088; &#1056;&#1077;&#1087;&#1091;&#1090;&#1072;&#1094;&#1080;&#1103;", "&#1057;&#1080;&#1089;&#1090;&#1077;&#1084;&#1072; &#1088;&#1077;&#1087;&#1091;&#1090;&#1072;&#1094;&#1080;&#1080;", tog("rep_enabled")),
            ("&#127918; &#1048;&#1075;&#1088;&#1099;", "&#1056;&#1072;&#1079;&#1074;&#1083;&#1077;&#1082;&#1072;&#1090;&#1077;&#1083;&#1100;&#1085;&#1099;&#1077; &#1082;&#1086;&#1084;&#1072;&#1085;&#1076;&#1099;", tog("games_enabled")),
            ("&#128176; &#1069;&#1082;&#1086;&#1085;&#1086;&#1084;&#1080;&#1082;&#1072;", "&#1052;&#1072;&#1075;&#1072;&#1079;&#1080;&#1085;, &#1072;&#1091;&#1082;&#1094;&#1080;&#1086;&#1085;", tog("economy_enabled")),
            ("&#128140; &#1040;&#1085;&#1086;&#1085;&#1080;&#1084;&#1082;&#1080;", "&#1040;&#1085;&#1086;&#1085;&#1080;&#1084;&#1085;&#1099;&#1077; &#1089;&#1086;&#1086;&#1073;&#1097;&#1077;&#1085;&#1080;&#1103;", tog("anon_enabled")),
            ("&#129309; &#1050;&#1083;&#1072;&#1085;&#1099;", "&#1057;&#1080;&#1089;&#1090;&#1077;&#1084;&#1072; &#1082;&#1083;&#1072;&#1085;&#1086;&#1074;", tog("clans_enabled")),
        )}
        {section("&#127942; &#1069;&#1082;&#1086;&#1085;&#1086;&#1084;&#1080;&#1082;&#1072;",
            ("&#11088; XP &#1079;&#1072; &#1089;&#1086;&#1086;&#1073;&#1097;&#1077;&#1085;&#1080;&#1077;", "", inp("xp_per_msg","number","1","100")),
            ("&#9200; &#1050;&#1091;&#1083;&#1076;&#1072;&#1091;&#1085; &#1088;&#1077;&#1087;&#1099; (&#1095;&#1072;&#1089;&#1086;&#1074;)", "", inp("rep_cooldown_hours","number","1","168")),
            ("&#127873; &#1044;&#1085;&#1077;&#1074;&#1085;&#1086;&#1081; &#1073;&#1086;&#1085;&#1091;&#1089;", "", inp("daily_bonus","number","1","10000")),
            ("&#127381; &#1041;&#1086;&#1085;&#1091;&#1089; &#1085;&#1086;&#1074;&#1080;&#1095;&#1082;&#1091;", "", inp("newcomer_bonus","number","0","10000")),
        )}
        {section("&#128226; &#1040;&#1074;&#1090;&#1086;-&#1086;&#1073;&#1098;&#1103;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103;",
            ("&#128226; &#1040;&#1074;&#1090;&#1086;-&#1086;&#1073;&#1098;&#1103;&#1074;&#1083;&#1077;&#1085;&#1080;&#1077;", "&#1054;&#1090;&#1087;&#1088;&#1072;&#1074;&#1083;&#1103;&#1090;&#1100; &#1089;&#1086;&#1086;&#1073;&#1097;&#1077;&#1085;&#1080;&#1077; &#1087;&#1086;&#1074;&#1090;&#1086;&#1088;&#1085;&#1086;", tog("announce_enabled")),
            ("&#128221; &#1058;&#1077;&#1082;&#1089;&#1090; &#1086;&#1073;&#1098;&#1103;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103;", "", f'<textarea class="form-control" name="announce_text" rows="2">{s.get("announce_text","")}</textarea>'),
            ("&#128260; &#1050;&#1072;&#1078;&#1076;&#1099;&#1077; N &#1089;&#1086;&#1086;&#1073;&#1097;.", "", inp("announce_interval","number","10","10000")),
            ("&#128220; &#1053;&#1072;&#1087;&#1086;&#1084;&#1080;&#1085;&#1072;&#1085;&#1080;&#1077; &#1087;&#1088;&#1072;&#1074;&#1080;&#1083;", "", tog("rules_remind_enabled")),
            ("&#128260; &#1050;&#1072;&#1078;&#1076;&#1099;&#1077; N &#1089;&#1086;&#1086;&#1073;&#1097;. (&#1087;&#1088;&#1072;&#1074;&#1080;&#1083;&#1072;)", "", inp("rules_remind_interval","number","50","10000")),
        )}
    ...
    <div class="container">
      ...
      <div class="section" style="padding:20px;">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
          ...
          <a class="btn btn-primary" href="/dashboard/chat_settings/{cid}">&#9881;&#65039; &#1053;&#1072;&#1089;&#1090;&#1088;&#1086;&#1081;&#1082;&#1080; &#1095;&#1072;&#1090;&#1072;</a>
        </div>
      </div>
      <div class="section" style="margin-top:20px;">
