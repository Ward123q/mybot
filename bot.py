...
async def cmd_help(message: Message):
    ...
    text = (
        ...
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "👤 <b>Профиль:</b>\n"
        "/profile — профиль | /ранг — уровень | /streak — стрик\n"
        "/info — инфо (реплай) | /warnings — варны (реплай)\n"
        "/avatar — выбрать аватар эмодзи\n\n"
        "⭐ <b>Репутация:</b>\n"
        "/rep — репутация | /toprep — топ | /top — топ активных\n"
        "/daily — ежедневный бонус | /shop — магазин титулов\n"
        "/giverep [сумма] — перевести репу (реплай)\n"
        "/like — лайк (реплай) +1 | /dislike — дизлайк -1\n\n"
        "🎮 <b>Игры и экономика:</b>\n"
        "/casino [сумма] — казино | /duel [сумма] — дуэль\n"
        "/roulette [сумма] — рулетка (x2 или потерять всё)\n"
        "/lottery — лотерея | /lottery_buy — купить билет (20 репы)\n"
        "/stock — биржа репы | /stock_invest — вложить\n"
        "/trivia — викторина за репу\n\n"
        "🍭 <b>Бустеры и предметы:</b>\n"
        "/boost — магазин бустеров за репу\n"
        "/artifact — мои артефакты | /artifact_roll — получить (100 репы)\n\n"
        "🤝 <b>Кланы:</b>\n"
        "/clan — мой клан | /clan_top — топ кланов\n"
        "/clan_create ТЕГ Название — создать (200 репы)\n"
        "/clan_join ТЕГ — вступить | /clan_leave — выйти\n\n"
        "💬 <b>Контент:</b>\n"
        "/quote_save — сохранить цитату (реплай)\n"
        "/quote_random — случайная цитата | /quotes — все цитаты\n"
        "/journal — личный дневник | /journal текст — добавить\n"
        "/meme верх|низ — сгенерировать мем\n"
        "/confession текст — анонимная исповедь\n\n"
        "🕵 <b>Анонимно:</b>\n"
        "/ask — открыть АСК | /send @юзер текст — вопрос\n"
        "/secret @юзер текст — анонимное лс\n\n"
        "📊 <b>Статистика:</b>\n"
        "/chatstats — статистика чата | /mystats — моя статистика\n"
        "/topactive — топ активных сегодня\n\n"
        "🛠 <b>Утилиты:</b>\n"
        "/rules — правила | /weather [город] — погода\n"
        "/afk — AFK | /report — жалоба | /remind — напоминание\n"
        "/birthday ДД.ММ — день рождения | /subscribe — события\n"
        "/ref — реферальная ссылка (+30 репы за друга)\n"
        "/role — роль дня | /join — турнир | /mvp — МВП (реплай)\n\n"
        "🎲 <b>Мини-игры:</b>\n"
        "/roll — кубик | /flip — монетка | /slot — слот\n"
        "/8ball [вопрос] | /rps к/н/б | /choose вар1|вар2 | /guess\n"
    )
    if is_adm:
        text += (
            "\n━━━━━━━━━━━━━━━━━━━━\n"
            "👮 <b>Администраторам:</b>\n\n"
            "/panel — панель (реплай) | /ban | /unban | /mute | /unmute\n"
            "/warn | /unwarn | /warn24 | /tempban | /rban\n"
            "/del — удалить | /clear N — очистить | /pin | /unpin\n"
            "/announce | /poll | /lock | /unlock | /slowmode\n"
            "/antimat | /autokick | /adminlist | /banlist\n"
            "/promote [тег] | /removetag | /modhistory | /modtop\n"
            "/tournament start/begin/next/stop\n"
            "/botstats | /broadcast текст — рассылка по чатам\n"
