...
_AGGRO_WORDS = [
    ...
    'ты пожалееш', 'найду тебя', 'найду теб', 'достану тебя',
    ...
    'завали еб',
    'тупорылост', 'тупоумие', 'придурковат', 'недоразвитост',
    'скудоумие', 'безмозглост', 'тупорогост', 'деревянноголов',
    'полудурье', 'дурачество', 'балбесин', 'обалдуй',
    'оболтусин', 'тупайс', 'тупень', 'тупизн',
    'дуралей', 'дурында', 'остолопин', 'недоумочност',
    'кретинищ', 'дебилоидн', 'имбецильн', 'идиотиничн',
    'клиническ идиот', 'умственно убог', 'мозгов с гулькин', 'ни ума ни',
    'дурак дураком', 'тупее пробки', 'тупее валенка', 'мразотин',
    'мерзотин', 'паскудство', 'гнидск', 'подонковщин',
    'сволочизм', 'сволочьё', 'тварство', 'гадство',
    'скотств', 'быдлятин', 'быдлоид', 'хамство',
    'хамьюга', 'жлобство', 'нищебродск', 'голодранств',
    'оборванств', 'помойщик', 'клоунск', 'шутовск',
    'паясничеств', 'фиглярств', 'мразь конченн', 'выродочн',
    'ублюдочност', 'отбросн', 'отребьев', 'швалин',
    'шушерн', 'падальн', 'гнильц', 'гнилостн',
    'мерзопакостн', 'крысятничеств', 'шныровск', 'барыжничеств',
    'спекулянтск', 'живоглотств', 'кровопийств', 'паразитизм',
    'нахлебник', 'дармоед', 'тунеядец', 'прихлебатель',
    'приживала', 'присосалс', 'трусливост', 'трусопат',
    'ссыкливост', 'зассанец', 'очкун', 'очковтиратель',
    'слабачеств', 'тряпичност', 'мямленье', 'нытьишк',
    'плаксивост', 'сопляческ', 'хлюпиков', 'дрищеват',
    'дохлятинк', 'заморышн', 'задротств', 'ботанств',
    'лошарск', 'лоховщин', 'терпильств', 'петушинск',
    'опущенств', 'шестёрочн', 'холуйств', 'подхалимаж',
    'лизоблюдств', 'подстилочн', 'шакальн', 'слизнячеств',
    'безвольност', 'тюфячн', 'недомужичн', 'слюнтяйск',
    'нюнеть', 'раскисл', 'разнюнилс', 'сдрейфилс',
    'струсилс', 'пидорск', 'пидарск', 'пидрильск',
    'педрильн', 'педофильск', 'гомосячеств', 'шлюшеств',
    'блядовск', 'блядство', 'блядюшк', 'проститутск',
    'потаскушеств', 'шалавск', 'давалкин', 'мандавошечн',
    'сучество', 'сученышев', 'шкурничеств', 'целкин',
    'пиздюшн', 'пиздаболь', 'хуеплётск', 'членососн',
    'спермоглотск', 'блудняк', 'распутств', 'развратниче',
    'гулящест', 'панельщиц', 'путанск', 'шмарин',
    'марушн', 'сожительск', 'самкин', 'кобелин',
    'озабоченн', 'извращенц', 'извращенск', 'эксгибициониз',
    'трансушн', 'ротожопн', 'ротоблудн', 'залупоконск',
    'сдохн бы', 'подохн бы', 'здохн бы', 'удушу теб',
    'удавлю теб', 'утоплю теб', 'спалю теб', 'сожгу теб',
    'взорву теб', 'расчленю', 'расчленю теб', 'четвертую',
    'выпотрошу', 'кишки выпущу', 'кишки вырву', 'глаза выколю',
    'зубы выбью', 'челюсть сломаю', 'нос расквашу', 'башку проломлю',
    'череп проломлю', 'мозги вышибу', 'пристрелю', 'застрелю',
    'зарою живьём', 'в землю закатаю', 'в бетон закатаю', 'на ремни порежу',
    'на куски порежу', 'фарш сделаю', 'отбивную сделаю', 'калекой сделаю',
    'инвалидом останешь', 'ходить не будеш', 'жить не будеш', 'света не увид',
    'дни сочтены', 'часы сочтены', 'недолго осталось', 'скоро сдохнеш',
    'готовь гроб', 'рой могилу', 'молись пока', 'покойся с',
    'уже мертвец', 'ходячий труп', 'трупом будеш', 'на ноль помножу',
    'найду и убью', 'из-под земли достан', 'нигде не спрячеш', 'везде найду',
    ...
    'nobody loves u', 'everyone hates u',
]
