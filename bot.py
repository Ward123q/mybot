...
_AGGRO_WORDS = [
    'тупой', 'тупиц', 'тупост', 'туполоб',
    'тупорыл', 'дебил', 'дебиль', 'идиот',
    'идиётск', 'кретин', 'имбецил', 'даун',
    'даунизм', 'олигофрен', 'умственно отстал', 'недоразвит',
    'слабоумн', 'скудоумн', 'безмозгл', 'безголов',
    'безмозг', 'тормоз', 'тормознут', 'недалёк',
    'недалек', 'примитив', 'узколоб', 'недоумок',
    'недоумк', 'дурак', 'дура', 'дурочк',
    'дурын', 'придурок', 'придурк', 'придурош',
    'балбес', 'болван', 'остолоп', 'тупарь',
    'деревянн башк', 'дуб', 'дубина', 'дубьё',
    'пенёк', 'пенек', 'валенок', 'тормозн',
    'отсталый', 'отсталая', 'даунёныш', 'даунен',
    'мозгов нет', 'без мозгов', 'мозги где', 'мозга нет',
    'еблан', 'ебланск', 'долбоёб', 'долбоеб',
    'долбаёб', 'долбаеб', 'долбоящер', 'дегенерат',
    'выродок', 'недочеловек', 'убогий', 'убогая',
    'убог', 'ничтожеств', 'ничтожн', 'никчём',
    'никчем', 'пустое мест', 'пустышк', 'ноль без палочк',
    'мраз', 'мразот', 'сволоч', 'подонок',
    'подонк', 'гнид', 'гнусн', 'мерзав',
    'мерзк', 'мерзот', 'урод', 'уродин',
    'уродлив', 'уродец', 'уёбищ', 'уебищ',
    'убожеств', 'чмо', 'чмошник', 'чмырь',
    'чмыр', 'ублюдок', 'ублюдк', 'выблядок',
    'выблядк', 'отброс', 'отребье', 'шваль',
    'шушер', 'гнилой', 'гнилая', 'гнильё',
    'падаль', 'паскуд', 'паскудин', 'тварь',
    'твар', 'тварин', 'гадин', 'гад',
    'гадость', 'скотин', 'скот', 'животн тупо',
    'быдло', 'быдлан', 'быдляк', 'хам',
    'хамло', 'хамьё', 'жлоб', 'жлобьё',
    'жлобск', 'деревня тупая', 'колхозник тупой', 'нищеброд',
    'нищук', 'голодранец', 'оборванец', 'бомж',
    'бомжар', 'бомжов', 'помойн', 'помоечн',
    'клоун', 'клоунад', 'клован', 'шут гороховый',
    'посмешищ', 'ничтожество', 'трус', 'трусиха',
    'трусли', 'ссыкло', 'ссыкун', 'ссыкл',
    'зассал', 'зассыш', 'очко играет', 'слабак',
    'слабачок', 'тряпк', 'тряпич', 'размазн',
    'мямл', 'нытик', 'нытьё', 'ноющ',
    'плакса', 'плаксив', 'рёва', 'рева',
    'сопляк', 'соплив', 'малохольн', 'хлюпик',
    'дрищ', 'дохляк', 'заморыш', 'задрот',
    'задрач', 'ботан тупой', 'лошар', 'лошок',
    'лошпед', 'лох', 'лохматрос', 'терпил',
    'терпильск', 'петух', 'петушар', 'петушин',
    'опущ', 'опущенец', 'зашкварен', 'зашквар',
    'шестёрк тупая', 'шестерк', 'холуй', 'прихвостень',
    'подхалим', 'лизоблюд', 'подлиз', 'жополиз',
    'жоп лиз', 'подстилк', 'шавк', 'шавка',
    'псин', 'шакал', 'пидор', 'пидар',
    'пидр', 'педик', 'педрил', 'педер',
    'гомик', 'гомосек', 'гей тупой', 'голубой опущ',
    'шлюх', 'шлюшк', 'шлюхен', 'блядин',
    'блядск', 'блядун', 'блядов', 'проститут',
    'потаскух', 'потаскун', 'шалав', 'шалаш',
    'давалк', 'давала', 'мандавошк', 'сучк',
    'сука', 'сукин', 'сучар', 'курв',
    'курва', 'шкур', 'шкура', 'шкурех',
    'шкурён', 'тёлк дешёв', 'телка деш', 'целка',
    'манда', 'мандень', 'пизда', 'пиздюк',
    'пиздабол', 'залупа', 'залуп', 'хуесос',
    'хуепутал', 'членосос', 'спермоглот', 'анус',
    'очко твоё', 'сдохни', 'сдохн', 'подохни',
    'подохн', 'здохни', 'убей себя', 'убейся',
    'убилб', 'убил бы', 'удавись', 'удавил',
    'повесься', 'повесил бы', 'повес', 'сожги себя',
    'прыгни с', 'выпили себя', 'выпились', 'выпилил',
    'самоубий', 'убить тебя', 'убью тебя', 'зарежу',
    'зарежем', 'прирежу', 'порешу', 'порешаю',
    'грохну', 'грохнем', 'замочу', 'замочим',
    'закопаю', 'закопаем', 'урою', 'уроем',
    'размажу', 'размажем', 'изобью', 'изобьём',
    'изобьем', 'отпизж', 'отпижд', 'ебало разобью',
    'рожу набью', 'морду набью', 'рыло начищу', 'голову оторву',
    'руки оторву', 'ноги переломаю', 'кости переломаю', 'придушу',
    'задушу', 'задавлю', 'сломаю тебе', 'пожалеешь',
    'найду тебя', 'достану тебя', 'выследю', 'ты труп',
    'тебе конец', 'тебе пизда', 'тебе хана', 'закончишь плохо',
    'домой не дойдёшь', 'домой не дойдеш', 'встретимся в реале', 'выйди в реал',
    'адрес узнаю', 'знаю где живёшь', 'знаю где живеш', 'за тобой придут',
    'никому не нужен', 'никому не нужна', 'всем похуй на теб', 'всем плевать на теб',
    'тебя никто не любит', 'тебя все ненавид', 'тебя ненавиж', 'ненавижу теб',
    'тебя терпеть', 'ты ничто', 'ты никто', 'ты пустое',
    'лучше б ты не родил', 'зря тебя родил', 'зачем ты родил', 'ошибка природы',
    'ошибка рожден', 'выкидыш', 'недоношен', 'зря живёшь',
    'зря живеш', 'коптишь небо', 'место на кладбищ', 'тебе не место',
    'вали отсюда', 'катись отсюда', 'уёбывай', 'уебывай',
    'съебись', 'съёбывай', 'съебывай', 'проваливай нахуй',
    'исчезни нахуй', 'сгинь', 'заткни пасть', 'завали ебало',
    'завали пасть', 'закрой рот', 'закрой свой рот', 'молчи в тряпочк',
    'рот закрой', 'рот завали', 'не вякай', 'не пизди',
    'хорош пиздеть', 'ты обуза', 'ты груз', 'от тебя одни проблем',
    'от тебя вред', 'лучше б тебя', 'без тебя лучше', 'тебя забудут',
    'тебя не вспомн', 'о тебе никто', 'ты позор', 'позор семьи',
    'позорищ', 'стыдно за теб', 'убожество ходяч', 'ходячее недоразумен',
    'днище', 'дно', 'ты на дне', 'жирн',
    'жируха', 'жиртрест', 'жиробас', 'свинья жирн',
    'хряк', 'боров', 'туша', 'туш',
    'толстуха', 'толстяк жирн', 'ожирел', 'разъел рожу',
    'ряху разъел', 'урод страшн', 'страшил', 'страшила',
    'страшнее', 'рожа кривая', 'морда кривая', 'кривомордый',
    'косоглаз', 'косорыл', 'лысый череп', 'лысина блестит',
    'плешив', 'зубы гнилые', 'вонючк', 'вонюч',
    'воняешь', 'потн', 'пропотел', 'немыт',
    'грязнуля', 'чмошн вид', 'нищенск вид', 'анорексичк',
    'скелет ходяч', 'дрищ худой', 'глист', 'шпала',
    'каланча', 'коротыш', 'недомерок', 'карлик тупой',
    'пигмей', 'прыщав', 'угреват', 'рябой',
    'конопат', 'очкарик тупой', 'четырёхглаз', 'четырехглаз',
    'suka', 'blyat', 'blyad', 'pidor',
    'pidoras', 'mraz', 'tvar', 'gandon',
    'dolboeb', 'ebanat', 'huesos', 'mudak',
    'debil', 'idiot', 'urod', 'loh',
    'cmo', 'chmo', 'zaebal', 'poshel nahuy',
    'idi nahuy', 'ksebe', 'kill yourself', 'kys',
    'go die', 'neckrope', 'rope', 'an hero',
    'гандон', 'гондон', 'мудак', 'мудачьё',
    'мудил', 'мудозвон', 'распиздяй', 'разъебай',
    'ебанат', 'ёбнут', 'ебанут', 'ебанашк',
    'ёбарь', 'ебарь', 'выебок', 'заёбhouse',
    'заебал ты', 'заебала ты', 'заёбыва', 'заебыва',
    'говнюк', 'говноед', 'говнар', 'засранец',
    'засрал', 'обосрал', 'обоссал', 'зассан',
    'серун', 'ссыкоман', 'пердун', 'пердёж',
    'вонючий пердун', 'хмырь', 'хрен с горы', 'хер моржов',
    'членодевк', 'дрочер', 'дрочила', 'онанист тупой',
    'рукоблуд', 'импотент', 'кончен', 'конченый',
    'конченая', 'отморозок', 'отморозк', 'беспредельщик',
    'быдлоту', 'свиномордый', 'скотомудак',
    'нахуй', 'нах ', 'похуй', 'нахер',
    'похер', 'ебал', 'еба ', 'ёба',
    'уёб', 'уеб', 'заёб', 'заеб',
    'наёб', 'наеб', 'выёб', 'выеб',
    'ёбан', 'ебан', 'ёбну', 'ебну',
    'долбоё', 'долбое', 'ебуч', 'ёбуч',
    'хуй', 'хуё', 'хуе', 'хую',
    'хуя', 'хуи', 'нихуя', 'похуист',
    'пизд', 'пезд', 'манд', 'блят',
    'блядь', 'сук', 'нах', 'позор',
    'ничтож', 'днищ', 'дегенер', 'придур',
    'тупо', 'жир', 'свин', 'падл',
    'ублюд', 'выблял', 'выбляд', 'петуш',
    'быдл', 'здохн', 'убейс', 'убей себ',
    'удавис', 'выпилис', 'выпили себ', 'сожги себ',
    'прыгни', 'размаж', 'изобь', 'отпизд',
    'придуш', 'задуш', 'задавл', 'сломаю теб',
    'тебе пизд', 'найду теб', 'достану теб', 'выслеж',
    'знаю где жив', 'никому не нуж', 'всем похуй на', 'всем плевать на',
    'тебя никто', 'ненавиж теб', 'зря родил', 'зря тебя',
    'лучше б ты', 'ошибка природ', 'вали отсюд', 'катись отсюд',
    'уёбыв', 'уебыв', 'съёбыв', 'съебыв',
    'съебис', 'проваливай', 'заткн', 'завали ебал',
    'хорош пиздет', 'от тебя одни', 'без тебя лучш', 'ты дно',
    'на дне', 'ходячее недораз', 'страшн как', 'толстух',
    'свинья жир', 'туша жир', 'лысина', 'воняеш',
    'грязнул', 'очкарик', 'ботан туп', 'nahuy',
    'poshel na', 'idi na', 'kys ',
]
