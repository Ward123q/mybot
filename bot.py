...
_AGGRO_WORDS = [
    ...
    'баран безвольн', 'стадо', 'овощ', 'овощн',
    'тюфяк', 'недомужик', 'не мужик', 'полумужик',
    'бабёнк', 'тютя', 'рохл', 'слюнтяй',
    'слабонервн', 'истеричк', 'психопат слаб', 'нюня',
    'распустил сопл', 'разнюнил', 'скуксил', 'сдрейфил',
    'струсил', 'поджал хвост', 'хвост поджал', 'спрятался как',
    'пидор', 'пидар', 'пидр', 'пидорас',
    'пидорг', 'пидрила', 'педик', 'педрил',
    'педер', 'педофил', 'гомик', 'гомосек',
    'гомосятин', 'гей тупой', 'гей опущ', 'голубой опущ',
    'голубок гей', 'шлюх', 'шлюшк', 'шлюхен',
    'шлюховск', 'шлюшар', 'блядин', 'блядск',
    'блядун', 'блядов', 'блядищ', 'блятство',
    'проститут', 'проститук', 'потаскух', 'потаскун',
    'потаскушк', 'шалав', 'шалашовк', 'шалашн',
    'давалк', 'давала', 'давалов', 'мандавошк',
    'мандовошк', 'сучк', 'сука', 'сукин',
    'сучар', 'сученыш', 'сучий', 'курв',
    'курва', 'курвин', 'шкур', 'шкура',
    'шкурех', 'шкурён', 'тёлк дешёв', 'телка деш',
    'целка', 'целочк', 'мандавош', 'мандень',
    'манденыш', 'пизда', 'пиздюк', 'пиздабол',
    'пиздёнк', 'пиздоват', 'залупа', 'залуп',
    'залупон', 'хуесос', 'хуесоск', 'хуепутал',
    'хуеплёт', 'хуеплет', 'членосос', 'членодевк',
    'спермоглот', 'спермобак', 'анус твой', 'очко твоё',
    'очкан', 'анальн раб', 'сперматозоид', 'гондон штопан',
    'резинка пользов', 'блудниц', 'распутн', 'развратн',
    'гулящ', 'шваль панельн', 'панельн дев', 'ночн бабочк',
    'жрица любв', 'путан', 'эскортниц', 'шмар',
    'шмара', 'марух', 'метрес', 'сожительниц',
    'любовниц дешёв', 'самка', 'сучка течн', 'кобель',
    'озабоч', 'извращен', 'извращ', 'эксгибицион',
    'педрильск', 'гомосятск', 'трансуха', 'транвестит',
    'шим', 'оральн раб', 'ротожоп', 'ротоблуд',
    'спермоприём', 'залупоконь', 'елдак', 'сдохни',
    'сдохн', 'сдохнеш', 'подохни', 'подохн',
    'подохнеш', 'здохни', 'здохн', 'убей себя',
    'убейся', 'убейс', 'убилб', 'убил бы',
    'убить себя', 'удавись', 'удавис', 'удавил бы',
    'повесься', 'повес', 'повесил бы', 'вешайся',
    'сожги себя', 'сожги себ', 'спрыгни', 'прыгни с',
    'прыгай с', 'выпили себя', 'выпилис', 'выпилил',
    'выпили себ', 'самоубий', 'суициднись', 'вскрой вены',
    'вены вскр', 'вскройся', 'убить тебя', 'убью тебя',
    'убью нахуй', 'зарежу', 'зарежем', 'режу теб',
    'прирежу', 'порешу', 'порешаю', 'порешим',
    'грохну', 'грохнем', 'грохну теб', 'замочу',
    'замочим', 'мочи его', 'закопаю', 'закопаем',
    'закопаю теб', 'урою', 'уроем', 'урою теб',
    'размажу', 'размажем', 'размажу по', 'изобью',
    'изобьём', 'изобьем', 'отпизж', 'отпижд',
    'отхуяч', 'ебало разобью', 'ебло разобью', 'рожу набью',
    'морду набью', 'морду расквас', 'рыло начищу', 'рыло сверну',
    'табло набью', 'голову оторву', 'башку оторву', 'руки оторву',
    'ноги переломаю', 'кости переломаю', 'рёбра перелом', 'хребет сломаю',
    'шею сверну', 'придушу', 'задушу', 'задавлю',
    'задавим', 'сломаю тебе', 'сломаю теб', 'покалечу',
    'изувечу', 'искалечу', 'инвалидом сдел', 'на костыл',
    'в больниц попад', 'в реанимац', 'в морг', 'на тот свет',
    'закопают теб', 'гроб заколоч', 'могил вырою', 'пожалеешь',
    'ты пожалееш', 'найду тебя', 'найду и убью', 'достану тебя',
    'достану теб', 'выследю', 'выслеж', 'вычислю теб',
    'адрес узнаю', 'адрес пробью', 'знаю где живёшь', 'знаю где живеш',
    'знаю где ты', 'за тобой придут', 'придём за теб', 'ты труп',
    'ты покойник', 'тебе конец', 'тебе пизд', 'тебе хана',
    'тебе кранты', 'тебе крышка', 'конец тебе', 'закончишь плохо',
    'плохо кончиш', 'домой не дойдёшь', 'домой не дойдеш', 'живым не уйдёш',
    'ноги вырву', 'никому не нужен', 'никому не нужна', 'никому ненуж',
    'всем похуй на теб', 'всем плевать на теб', 'всем насрать на теб', 'тебя никто не любит',
    'тебя никто не лю', 'тебя все ненавид', 'все тебя ненавид', 'тебя ненавиж',
    'ненавижу теб', 'тебя терпеть', 'терпеть тебя не', 'ты ничто',
    'ты никто', 'ты пустое', 'ты пустышк', 'лучше б ты не родил',
    'лучше бы не родил', 'зря тебя родил', 'зря родил', 'зачем ты родил',
    'зачем родил', 'ошибка природы', 'ошибка природ', 'ошибка рожден',
    'выкидыш', 'недоношен', 'аборт надо был', 'тебя надо был абортир',
    'зря живёшь', 'зря живеш', 'зря коптишь', 'коптишь небо',
    'небо коптиш', 'место на кладбищ', 'тебе место на кладб', 'тебе не место',
    'тут тебе не место', 'вали отсюда', 'вали отсюд', 'катись отсюда',
    'катись отсюд', 'катись колбас', 'уёбывай', 'уебывай',
    'уёбыв', 'уебыв', 'съебись', 'съебис',
    'съёбывай', 'съебывай', 'съёбыв', 'съебыв',
    'свали уже', 'свали нахуй', 'исчезни', 'исчезни нахуй',
    'сгинь', 'проваливай', 'проваливай нахуй', 'пшёл вон',
    'пошёл вон', 'пошел вон', 'выметайся', 'убирайся',
    'заткни пасть', 'завали ебало', 'завали ебло', 'завали пасть',
    'завали хлебал', 'закрой рот', 'закрой свой рот', 'рот закрой',
    'рот завали', 'рот прикрой', 'молчи в тряпочк', 'в тряпочк молчи',
    'не вякай', 'не тявкай', 'не пизди', 'хорош пиздет',
    'хватит пиздет', 'не выёбывайся', 'не выебывайся', 'ты обуза',
    'ты груз', 'ты балласт', 'от тебя одни проблем', 'от тебя вред',
    'от тебя толку', 'без тебя лучше', 'без тебя обойд', 'лучше б тебя',
    'тебя забудут', 'тебя не вспомн', 'о тебе никто', 'ты позор',
    'позор семьи', 'позор рода', 'позорищ', 'ходячий позор',
    'стыдно за теб', 'стыд один', 'убожество ходяч', 'ходячее недоразумен',
    'ходячая ошибк', 'днище', 'днищ', 'ты на дне',
    'на самом дне', 'ниже плинтус', 'днищенск', 'днярь',
    'зашкварн ты', 'ты конч как человек', 'как человек ты ноль', 'человек-ошибка',
    'биомусор', 'биоотход', 'генетич мусор', 'мусор генет',
    'отработанн материал', 'расходник', 'пушечн мясо', 'никчёмн существ',
    'жалкое подоб', 'жалкое зрелищ', 'жалок ты', 'жирн',
    'жируха', 'жиртрест', 'жиробас', 'жиробан',
    'жирдяй', 'жирок наел', 'свинья жирн', 'свиноматк',
    'свиномордый', 'хряк', 'боров', 'кабан жирн',
    'тушка жир', 'толстуха', 'толстяк жирн', 'толстопуз',
    'пузан', 'пузатый', 'брюхан', 'брюхо отрастил',
    'ожирел', 'разъел рожу', 'рожу разъел', 'ряху разъел',
    'ряху наел', 'харю наел', 'щёки отъел', 'урод страшн',
    'страшил', 'страшила', 'страшнее', 'страшен как',
    'рожа кривая', 'морда кривая', 'морда кирпич', 'кривомордый',
    'криворыл', 'косоглаз', 'косорыл', 'косоглазик',
    'лысый череп', 'лысина блестит', 'лысина', 'плешив',
    'плешак', 'лысый чёрт', 'зубы гнилые', 'зубы кривые',
    'щербат', 'беззубый', 'гнилозуб', 'вонючк',
    'вонюч', 'воняешь', 'вонища от теб', 'потн',
    'пропотел', 'потлив', 'потные подмыш', 'немыт',
    'грязнуля', 'грязный как', 'чумаз', 'чушок',
    'чухан', 'нищенск вид', 'оборванск вид', 'анорексичк',
    'анорекс', 'скелет ходяч', 'скелетин', 'кощей',
    'кащей', 'дрищ худой', 'глист', 'глиста бледн',
    'шпала', 'каланча', 'дылда', 'оглобл',
    'коротыш', 'коротышк', 'недомерок', 'метр с кепк',
    'карлик', 'карлан', 'гном тупой', 'лилипут',
    'пигмей', 'прыщав', 'прыщеват', 'угреват',
    'угрёв', 'рябой', 'конопат', 'веснушч урод',
    'очкарик', 'очкарь', 'четырёхглаз', 'четырехглаз',
    'слепошар', 'косая морда', 'бледная немочь', 'синяк под глаз',
    'мешки под глаз', 'рожа опух', 'опухшая рожа', 'морщин старая',
    'старпёр', 'старпер', 'старая карга', 'карга',
    'ведьма старая', 'бабка дряхл', 'дед древний', 'развалин',
    'песок сыпл', 'обрюзг', 'обвисл', 'целлюлит',
    'жирные склад', 'складки жира', 'трёхэтажн подбород', 'второй подбород',
    'задница как', 'жопа толст', 'жопа разъел', 'suka',
    'suchka', 'blyat', 'blyad', 'blya',
    'pidor', 'pidoras', 'pidr', 'pidaras',
    'mraz', '",\\\\n    ', ', ', ',\\\\n    ',
    ', "you', 'ur trash', 'dumbass', 'dumbfuck',
    'retard', 'retarded', 'moron', 'imbecile',
    'asshole', 'bastard', 'motherf', 'fuck you',
    'fuck off', 'fuck u', 'gtfo', 'stfu',
    'cunt', 'whore', 'slut', 'bitch',
    'faggot', 'fagot', 'fag', 'dickhead',
    'piece of shit', 'pos', 'kys urself', 'go hang',
    'hang yourself', 'drink bleach', 'slit', 'cut yourself',
    'nobody loves', 'nobody likes', 'everyone hates', 'ur worthless',
    'you worthless', 'уебіще', 'сабака', 'пайдёш',
    'здохні', 'паміраеш', 'тупіца', 'дзяун',
    'ідыёт', 'вырадак', 'гандон', 'гондон',
    'гандошник', 'мудак', 'мудачьё', 'мудил',
    'мудозвон', 'мудень', 'мудак конч', 'распиздяй',
    'разъебай', 'разъёбан', 'ебанат', 'ёбнут',
    'ебанут', 'ебанашк', 'ёбарь', 'ебарь',
    'ёбырь', 'выебок', 'выёбок', 'заёбhouse',
    'заебал ты', 'заебала ты', 'заёбыва', 'заебыва',
    'задолбал ты', 'достал ты', 'говнюк', 'говноед',
    'говнар', 'говнюш', 'говнист', 'говённ',
    'говнецо', 'засранец', 'засрал', 'засранк',
    'обосрал', 'обоссал', 'обоссан', 'зассан',
    'серун', 'серунья', 'ссыкоман', 'пердун',
    'пердёж', 'пердун старый', 'вонючий пердун', 'пердабол',
    'хмырь', 'хмыр', 'хрен с горы', 'хер моржов',
    'хер с бугра', 'хрен моржов', 'членистоног', 'дрочер',
    'дрочила', 'дрочун', 'онанист тупой', 'рукоблуд',
    'рукоблудник', 'импотент', 'импотенц', 'кончен',
    'конченый', 'конченая', 'конченн', 'отморозок',
    'отморозк', 'отмороженн', 'беспредельщик', 'беспредел творит',
    'быдлоту', 'скотомудак', 'ебланище', 'хуило',
    'хуйло', 'хуила', 'хуеглот', 'елда',
    'хер тебе', 'хуй тебе', 'иди в жопу', 'иди в пизду',
    'пшёл нахуй', 'пошёл нахуй', 'пошел нахуй', 'да пошёл ты',
    'да иди ты', 'в рот ебал', 'в рот тебя', 'ебал я теб',
    'ебал тебя', 'насрать на теб', 'насрал на теб', 'похуй на теб',
    'хуй на теб', 'хуй забил', 'забей хуй', 'выкуси',
    'соси хуй', 'сосни хуйц', 'иди соси', 'хрен соси',
    'жри говно', 'сожри говно', 'ешь говно', 'говно жуй',
    'говна поешь', 'утрись', 'заглохни', 'завянь',
    'сдулся ты', 'слился ты', 'обтекай', 'обтекаешь',
    'утекай', 'умойся', 'умылся ты', 'проглоти язык',
    'язык проглоти', 'прикуси язык', 'ебало', 'ебло',
    'заткни еб', 'ебал', 'kill yourself', 'kill urself',
    'kys', 'go die', 'никому не нуж', 'ты ненуж',
    'завали еб', 'тупорылост', 'тупоумие', 'придурковат',
    'недоразвитост', 'скудоумие', 'безмозглост', 'тупорогост',
    'деревянноголов', 'полудурье', 'дурачество', 'балбесин',
    'обалдуй', 'оболтусин', 'тупайс', 'тупень',
    'тупизн', 'дуралей', 'дурында', 'остолопин',
    'недоумочност', 'кретинищ', 'дебилоидн', 'имбецильн',
    'идиотиничн', 'клиническ идиот', 'умственно убог', 'мозгов с гулькин',
    'ни ума ни', 'дурак дураком', 'тупее пробки', 'тупее валенка',
    'мразотин', 'мерзотин', 'паскудство', 'гнидск',
    'подонковщин', 'сволочизм', 'сволочьё', 'тварство',
    'гадство', 'скотств', 'быдлятин', 'быдлоид',
    'хамство', 'хамьюга', 'жлобство', 'нищебродск',
    'голодранств', 'оборванств', 'помойщик', 'клоунск',
    'шутовск', 'паясничеств', 'фиглярств', 'мразь конченн',
    'выродочн', 'ублюдочност', 'отбросн', 'отребьев',
    'швалин', 'шушерн', 'падальн', 'гнильц',
    'гнилостн', 'мерзопакостн', 'крысятничеств', 'шныровск',
    'барыжничеств', 'спекулянтск', 'живоглотств', 'кровопийств',
    'паразитизм', 'нахлебник', 'дармоед', 'тунеядец',
    'прихлебатель', 'приживала', 'присосалс', 'трусливост',
    'трусопат', 'ссыкливост', 'зассанец', 'очкун',
    'очковтиратель', 'слабачеств', 'тряпичност', 'мямленье',
    'нытьишк', 'плаксивост', 'сопляческ', 'хлюпиков',
    'дрищеват', 'дохлятинк', 'заморышн', 'задротств',
    'ботанств', 'лошарск', 'лоховщин', 'терпильств',
    'петушинск', 'опущенств', 'шестёрочн', 'холуйств',
    'подхалимаж', 'лизоблюдств', 'подстилочн', 'шакальн',
    'слизнячеств', 'безвольност', 'тюфячн', 'недомужичн',
    'слюнтяйск', 'нюнеть', 'раскисл', 'разнюнилс',
    'сдрейфилс', 'струсилс', 'пидорск', 'пидарск',
    'пидрильск', 'педрильн', 'педофильск', 'гомосячеств',
    'шлюшеств', 'блядовск', 'блядство', 'блядюшк',
    'проститутск', 'потаскушеств', 'шалавск', 'давалкин',
    'мандавошечн', 'сучество', 'сученышев', 'шкурничеств',
    'целкин', 'пиздюшн', 'пиздаболь', 'хуеплётск',
    'членососн', 'спермоглотск', 'блудняк', 'распутств',
    'развратниче', 'гулящест', 'панельщиц', 'путанск',
    'шмарин', 'марушн', 'сожительск', 'самкин',
    'кобелин', 'озабоченн', 'извращенц', 'извращенск',
    'эксгибициониз', 'трансушн', 'ротожопн', 'ротоблудн',
    'залупоконск', 'сдохн бы', 'подохн бы', 'здохн бы',
    'удушу теб', 'удавлю теб', 'утоплю теб', 'спалю теб',
    'сожгу теб', 'взорву теб', 'расчленю', 'расчленю теб',
    'четвертую', 'выпотрошу', 'кишки выпущу', 'кишки вырву',
    'глаза выколю', 'зубы выбью', 'челюсть сломаю', 'нос расквашу',
    'башку проломлю', 'череп проломлю', 'мозги вышибу', 'пристрелю',
    'застрелю', 'зарою живьём', 'в землю закатаю', 'в бетон закатаю',
    'на ремни порежу', 'на куски порежу', 'фарш сделаю', 'отбивную сделаю',
    'калекой сделаю', 'инвалидом останешь', 'ходить не будеш', 'жить не будеш',
    'света не увид', 'дни сочтены', 'часы сочтены', 'недолго осталось',
    'скоро сдохнеш', 'готовь гроб', 'рой могилу', 'молись пока',
    'покойся с', 'уже мертвец', 'ходячий труп', 'трупом будеш',
    'на ноль помножу', 'из-под земли достан', 'нигде не спрячеш', 'везде найду',
    'достану везде', 'никто не любит теб', 'всем на тебя плев', 'всем ты безразлич',
    'никому не интерес', 'тебя все презир', 'презираю теб', 'брезгую тобой',
    'противен ты', 'омерзителен ты', 'тошнит от теб', 'блевать от теб',
    'воняет от теб', 'фу какой ты', 'мерзкий ты', 'жалкий ты',
    'ничтожный ты', 'пустой ты', 'бесполезный ты', 'никчёмный ты',
    'зря живёш', 'лучше сдохн', 'лучше б сдох', 'зря родилс',
    'не надо было рожать', 'выкидышем надо был', 'семья стыдит', 'родители стыдят',
    'позоришь всех', 'всех позориш', 'на тебе пробы негде', 'клеймо ставить негде',
    'на самом дне ты', 'ниже некуда ты', 'хуже не быва', 'отбитый ты',
    'больной на голову', 'псих ненормальн', 'шизик', 'шизоид',
    'даун конченн', 'уёбок конченн', 'конч ты как личност', 'как личность ты ноль',
    'ты пустое место', 'тебя забудут через', 'о тебе не вспомн', 'следа не остан',
    'мокрого места не', 'жиробасин', 'жиртрестин', 'жирдяйск',
    'свинорыл', 'свинопас', 'кабанид', 'боровин',
    'тушин', 'толстожоп', 'жопаст', 'пузатост',
    'брюхатост', 'обжорск', 'рожемордый', 'мордоворот',
    'кривожоп', 'косопуз', 'косоморд', 'лысопер',
    'плешивост', 'зубоскал', 'гнилозубост', 'вонючест',
    'потливост', 'грязнулин', 'чумазост', 'сопленос',
    'прыщеморд', 'угреморд', 'рябоморд', 'конопатост',
    'веснушчат', 'очкастост', 'слепошарост', 'дохлятск',
    'костлявост', 'скелетоподобн', 'глистоподобн', 'дрищеватост',
    'шпалоподобн', 'каланчист', 'недомерочн', 'карликов',
    'гномьес', 'лилипутск', 'уродск', 'страховидл',
    'страхолюдн', 'образин', 'рожа кирпич', 'морда топор',
    'лицо кирпич', 'рожа клином', 'мордень', 'гандонск',
    'гондонск', 'мудачест', 'мудозвонск', 'распиздяйств',
    'разъебайств', 'ебанатск', 'ебанутост', 'ебланство',
    'ёбнутост', 'выебонск', 'заёбанн', 'задолбавш',
    'говнюжеств', 'говноедск', 'говнярск', 'засранств',
    'обосранн', 'обоссанн', 'серунск', 'пердунск',
    'хмырьё', 'дрочерск', 'дрочильн', 'онанистск',
    'рукоблудств', 'импотентск', 'конченост', 'отморозочн',
    'беспредельн', 'свиномордост', 'скотомудачь', 'хуилов',
    'хуйлищ', 'хуеглотск', 'елдачн', 'в рот ногами',
    'в рот компот', 'в очко', 'в анус', 'соси банан',
    'соси залуп', 'на хую вертел', 'хуй с тобой', 'хуй на рыло',
    'насрать мне на', 'плевать мне на', 'ноль для меня', 'пустое место для',
    'suchara', 'blyadina', 'pidorasina', 'mudilo',
    'debilojd', 'urodina', 'lohushka', 'chmoshnik',
    'zaebal ty', 'poshel ty', 'idi ty nahuy', 'huyeglot',
    'hueplet', 'mrazota', 'tvarina', 'scumbag',
    'lowlife', 'degenerate', 'subhuman', 'worthless piece',
    'kill yrself', 'go die already', 'nobody cares about', 'everyone hates you',
    'ur a loser', 'youre pathetic', 'безмозгло', 'тупоголо',
    'тупоумо', 'скудоумо', 'придурочеств', 'дебилизаци',
    'идиотств', 'кретиниз', 'имбецильност', 'олигофреник',
    'дегенеративност', 'даунячест', 'умалишённост', 'слабоумств',
    'тупоумств', 'недоразвитк', 'умом не блещ', 'мозги набекрен',
    'без царя в голов', 'крыша поехал', 'крыша съехал', 'ку-ку ты',
    'ауешник тупой', 'тупое животн', 'интеллекта ноль', 'ноль мозгов',
    'мозг ампутир', 'извилин нет', 'одна извилин', 'думать нечем',
    'соображалк нет', 'котелок не вар', 'голова два уха', 'дубовая башк',
    'деревянная башк', 'мразотищ', 'мерзавчик', 'подончик',
    'гнидыш', 'сволочуг', 'тварюшк', 'гадёнышев',
    'скотиняк', 'быдляра', 'хамьюжник', 'жлобяра',
    'нищеброж', 'голодранчик', 'босяцк', 'клоунессн',
    'паяцств', 'фигляж', 'крысёнышев', 'шныряг',
    'барыжник', 'спекуляж', 'живоглотн', 'кровопивец',
    'паразитск', 'нахлебнич', 'дармоедств', 'тунеядств',
    'прихлебательств', 'приживальств', 'мерзотник', 'выблядыш',
    'падальщин', 'стервятничеств', 'шавкодав', 'шакальств',
    'трусишка позорн', 'ссыкунишк', 'зассыха', 'очкарь трусл',
    'слабачишк', 'тряпколог', 'мямлик', 'нытикан',
    'плаксун', 'соплежуй', 'соплежевател', 'хлюпикан',
    'дрищеван', 'дохлячок', 'заморышек', 'задротяра',
    'ботанюг', 'лошарик', 'лошпедик', 'терпилушк',
    'петушара', 'опущенчик', 'зашкварник', 'шестёрочник',
    'холуйчик', 'подхалимчик', 'лизоблюдик', 'жополизик',
    'подстилочк', 'шавочк', 'пидорочк', 'пидарюг',
    'педрильчик', 'гомосятник', 'шлюхозавр', 'блядюга',
    'проститутищ', 'потаскунья', 'шалавушк', 'давалочк',
    'мандавошечк', 'сученция', 'курвишк', 'шкуреха',
    'мандюк', 'пиздюшок', 'пиздаболк', 'залупник',
    'хуесосина', 'членососка', 'блудняга', 'распутниц',
    'развратниц', 'гулёна', 'панельщин', 'путанк',
    'шмарюг', 'самкан', 'кобелина', 'озабоченк',
    'извращуг', 'эксгибиц', 'трансушк', 'ротожопик',
    'залупоконин', 'удавлю гад', 'утоплю гад', 'зарежу гад',
    'прирежу гад', 'грохну гад', 'замочу гад', 'урою гад',
    'размажу гад', 'изобью гад', 'придушу гад', 'задушу гад',
    'закопаю гад', 'расчленю гад', 'выпотрошу теб', 'кишки намотаю',
    'голову снесу', 'башку снесу', 'шею сверну теб', 'рёбра пересчита',
    'зубы посчита', 'руки вырву', 'язык вырву', 'глотку перегрызу',
    'горло перережу', 'вены вскрою теб', 'на органы пущу', 'на мясо пущу',
    'в фарш', 'в труху', 'сотру в порошок', 'живого места не остав',
    'места живого не', 'мокрого места не остав', 'из тебя отбивн', 'похороню теб',
    'закатаю в асфальт', 'сгною теб', 'уничтожу теб', 'раздавлю теб',
    'сломаю жизнь теб', 'жизни не дам', 'достану из-под', 'найду где угодно',
    'всё равно найду', 'тебя все презирают', 'все над тобой смеют', 'посмешище ты',
    'объект насмешек', 'клоун для всех', 'тебя все используют', 'ты для битья',
    'мальчик для битья', 'груша для битья', 'козёл отпущения', 'вечный неудачник',
    'по жизни лох', 'по жизни терпил', 'родился неудачник', 'проклятье семьи',
    'обуза для всех', 'балласт для чата', 'гиря на ногах', 'камень на ше',
    'токсичное чмо', 'энергетический вампир', 'нытик вечный', 'зануда конченн',
    'душнила конченн', 'токсик ты', 'никому ты не друг', 'друзей у тебя нет',
    'один как перст', 'всеми брошен', 'всеми покинут', 'никто не заплач',
    'забудут на след', 'следа не остав', 'пустое место занима', 'жирнота',
    'жиробасищ', 'жиртрестищ', 'свинорылост', 'кабанист',
    'боровист', 'тушища', 'толстожопост', 'пузатищ',
    'брюхатищ', 'обжорищ', 'мордоворотн', 'кривомордост',
    'косопузост', 'лысопузост', 'плешивец', 'зубоскалищ',
    'гнилозубищ', 'потнота', 'грязнулищ', 'сопленосн',
    'прыщавост', 'угревост', 'рябость', 'веснушчатост',
    'слепошарость', 'костлявец', 'глистин', 'дрищин',
    'шпалин', 'каланчин', 'коротышок', 'недомерочк',
    'карличеств', 'гномищ', 'лилипутищ', 'уродин конченн',
    'страховидлищ', 'страхолюдищ', 'образинищ', 'гандонищ',
    'гондонищ', 'мудачищ', 'мудозвонищ', 'распиздяйщин',
    'ебанатищ', 'ебланищ', 'выебонищ', 'говнюжищ',
    'говноедищ', 'засранищ', 'серунищ', 'пердунищ',
    'дрочерищ', 'онанистищ', 'импотентищ', 'отморозищ',
    'беспределыщик', 'свиномордищ', 'хуилищ', 'хуеглотищ',
    'залупоконищ', 'елдачищ', 'соси залупу', 'на хуй пош',
    'в рот тебе', 'в очко тебе', 'хуем по губам', 'обтекай говн',
    'жри говнищ', 'утрись говн', 'сожри дерьм', 'ешь дерьм',
    'говна навали', 'blyadyuga', 'pidorina', 'mudilishe',
    'debiloid', 'urodische', 'lohovshina', 'zaebalo ty',
    'poshel von', 'idi v zhopu', 'huesosina', 'mrazotina',
    'tvaryuga', 'lowlife scum', 'degenerate trash', 'subhuman filth',
    'worthless trash', 'kys loser', 'go rope', 'off yourself',
    'neck yourself', 'end yourself', 'nobody loves u', 'everyone hates u',
    'побью теб', 'отмудохаю', 'отметелю', 'отлуплю',
    'отдубашу', 'отхуячу', 'отпинаю', 'ногами запинаю',
    'забью ногами', 'запинаю до', 'отмолочу', 'ебало начищу',
    'табло начищу', 'фейс набью', 'лицо разобью', 'нос сломаю',
    'челюсть сверну', 'зубы вынесу', 'скулы сверну', 'бошку проломлю',
    'голову проломлю', 'череп раскрою', 'башню снесу', 'кость сломаю',
    'рёбра поломаю', 'ребро сломаю', 'руку сломаю', 'ногу сломаю',
    'пальцы переломаю', 'позвоночник сломаю', 'шею сломаю', 'свернуть шею',
    'покрошу', 'отметелю до', 'изобью до полус', 'убью теб',
    'убъю', 'пришью', 'завалю теб', 'прикончу',
    'укокошу', 'замочу теб', 'ножом пырну', 'пырну ножом',
    'заколю', 'зарублю', 'расстреляю', 'пулю в лоб',
    'пулю получишь', 'свинца получишь', 'удавлю', 'удушу',
    'утоплю', 'повешу', 'вздёрну', 'сожгу заживо',
    'спалю заживо', 'подорву', 'зарою', 'закатаю',
    'похороню', 'в могилу свед', 'в гроб загоню', 'отправлю на тот',
    'жизни лишу', 'лишу жизни', 'прикончу теб', 'кончу теб',
    'конец тебе придёт', 'сдохнешь от моих', 'от моей руки', 'мной будешь убит',
    'выпущу кишки', 'глаз выколю', 'язык вырежу', 'язык отрежу',
    'глотку перережу', 'глотку порву', 'вены вскрою', 'на куски',
    'на части порежу', 'на ремни', 'на фарш', 'в фарш пущу',
    'мясо сделаю', 'шашлык сделаю', 'на органы', 'скальп сниму',
    'шкуру спущу', 'кожу сдеру', 'живьём закопаю', 'живьём сожгу',
    'живьём съем', 'по частям', 'расчлененк', 'выслежу',
    'вычислю', 'адрес найду', 'из-под земли', 'где живёшь знаю',
    'знаю где ты живёш', 'приду к тебе домой', 'приеду к теб', 'встретимся в реал',
    'выйди в реал', 'выйдем поговорим', 'забьём стрелу', 'стрелку забьём',
    'тебе пиздец', 'тебе амба', 'ты мертвец', 'считай ты мёртв',
    'домой не вернёш', 'не доживёш', 'недолго протянеш', 'дни твои сочтен',
    'час твой близ', 'молись пока живой',
]
