...
RULES_TEXT = (
    ...
    "👉 Удаление сообщения\n\n"
    "☠️ <b>Токсичность</b>\n"
    "• Угрозы и призывы к суициду запрещены\n"
    "• Провокации и конфликты запрещены\n"
    "👉 Мут или бан\n\n"
    "🚫 <b>Общие правила</b>\n"
    "• Уважайте друг друга 😊\n"
    "• Общаемся только на русском\n"
    "• Только по теме чата\n\n"
    "💡 Просто будьте вежливы и всё будет хорошо! 😊\n"
