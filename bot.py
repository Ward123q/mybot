...
async def cmd_help(message: Message):
    ...
    if is_adm:
        text += (
            ...
            "🔐 <b>РОЛИ И МОДЕРАЦИЯ</b>\n"
            "▸ /roles — список ролей модераторов\n"
            "▸ /myjournal — моя история действий в ЛС\n"
            "▸ /shifts — расписание смен\n"
            "▸ /modrating — рейтинг модераторов\n"
            "▸ /tasks — мои задачи\n"
            "▸ /donetask ID — отметить задачу выполненной\n"
            "▸ /modchat — войти/выйти из чата модераторов\n\n"

            "📌 <b>ЗАКРЕП И ЧАТ</b>\n"
            "▸ /pin заголовок — закрепить <i>(реплай)</i>\n"
            "▸ /pinmanager — управление закреплёнными\n"
            "▸ /autorules — авто-правила новичкам в ЛС вкл/выкл\n\n"
            ...
            "🚨 <b>РЕПОРТЫ</b>\n"
            "▸ /report — жалоба <i>(реплай)</i>\n"
            "▸ /blockreport — заблокировать репорты <i>(реплай)</i>\n"
            "▸ /reportarchive [@user] — архив репортов\n"
        )
    if message.from_user.id == OWNER_ID:
        text += (
            "\n━━━━━━━━━━━━━━━━━━━━━━\n"
            ...
            "🌍 <b>МУЛЬТИ-ЧАТ (в ЛС боту)</b>\n"
            "▸ /mypanel — панель всех чатов\n"
            "▸ /broadcast2 текст — сообщение во все чаты\n"
            "▸ /sosall — локдаун ВСЕХ чатов\n"
            "▸ /sosoff — разлокдаун всех чатов\n"
            "▸ /linkchats — связать чаты (бан везде)\n\n"

            "💣 <b>ЭКСТРЕННЫЕ</b>\n"
            "▸ /evacuation — кик всех кто зашёл за последний час\n"
            "▸ /quarantine — автомут новых участников на 24ч\n"
            "▸ /cleanup — удалить неактивных за 30 дней\n\n"

            "🔒 <b>БЕЗОПАСНОСТЬ</b>\n"
            "▸ /blacklist @user — глобальный бан во всех чатах\n"
            "▸ /unblacklist @user — убрать из чёрного списка\n"
            "▸ /giverole @user роль — выдать роль мода (только ты!)\n"
            "▸ /takerole @user — забрать роль\n"
            "▸ /vip @user — выдать/снять VIP статус\n\n"

            "🗄 <b>ДАННЫЕ</b>\n"
            "▸ /backup — бэкап всей базы файлом в ЛС\n"
            "▸ /resetchat — сброс данных чата\n"
            "▸ /clonechat ID1 ID2 — скопировать настройки\n"
            "▸ /audit — полный аудит чата в ЛС\n"
            "▸ /plugins — управление модулями бота\n"
            "▸ /calendar — календарь событий (баны/муты)\n\n"

            "📊 <b>АНАЛИТИКА</b>\n"
            "▸ /heatmap — активность по часам\n"
            "▸ /reportstats — статистика репортов\n\n"

            "🎯 <b>ЗАДАЧИ МОДЕРАТОРАМ</b>\n"
            "▸ /task текст [часы] — поставить задачу <i>(реплай)</i>\n"
